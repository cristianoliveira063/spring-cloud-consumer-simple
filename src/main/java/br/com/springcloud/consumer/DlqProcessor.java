...
public class DlqProcessor {
    ...
    private static final String ORIGINAL_QUEUE = "product.exchanges.product.queue";
    ...
    private Message attemptToRepair(Message failedMessage) {
        ...
        if(messageBody.contains("Teste")) {
            System.out.println("Repairing message: "+failedMessage.toString());
            messageBody = messageBody.replace("Teste Error", "Teste");
